        ...
        try {
            ...
            if (localFilePath) {
                ...
                if (this.isAppEnvironment()) {
                    ...
                    if (window.adScreenPlayer && window.adScreenPlayer.modules.cacheManager) {
                        try {
                            // 检查CacheManager是否已正确初始化
                            if (window.adScreenPlayer.modules.cacheManager.db) {
                                ...
                                // IndexedDB未初始化，直接网络播放
                                if (fileFormat === 'image') {
                                    this.showImage(fileUrl);
                                } else {
                                    this.showVideo(fileUrl);
                                }
                                console.warn('CacheManager IndexedDB未初始化，从网络播放:', fileUrl);
                            }
                        } catch (cacheError) {
